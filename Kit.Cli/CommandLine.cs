...
internal static class CommandLine
{
    ...
    public static string BuildUsage()
    {
        ...
        builder.AppendLine("\tkit manifest  --version <release version> --updater <stamped-updater.exe> --package <app-package.zip> [--installer <updater-refresh-installer.exe>] [--output <release-manifest.json>] [--updater-update-required <true|false>] [--delta-from-version <version> --delta-package <delta.zip> [--delta-delete-list <file>]]");
        builder.AppendLine("\tkit release --app-dir <app-dir-path> --config <stamp-config.json> --updater <blank-updater.exe> [--version <release-version>] [--output-dir <output-dir-path>] [--package-name <app-package.zip>] [--updater-update-required <true|false>] [--installer-command <command>] [--installer-args <args>] [--installer-path <installer-path>] [--delta-from-version <version> --delta-package <delta.zip> [--delta-delete-list <file>]]");
        builder.AppendLine();
